...
class StatsManager(object):
    ...
    def update_user_role_purchase_stats(self, user_id: int, key_to_update: str, amount: float):
...
StatsManager().update_user_role_purchase_stats(user_id=360367188432912385, key_to_update='xlmStats', amount=100.0)
